...
def heWeatherNow(city):
    ...
    try:
        ...
        speechText2 = "今天降水概率："+ forecast['pop']+"%，白天"+forecast['cond_txt_d']+"，夜间"+forecast['cond_txt_n'] + "；"
        speechText3 = "明天降水概率："+ forecast2['pop']+"%，白天"+forecast2['cond_txt_d']+"，夜间"+forecast2['cond_txt_n'] + "；"
        speechText4 = "后天降水概率："+ forecast3['pop']+"%，白天"+forecast3['cond_txt_d']+"，夜间"+forecast3['cond_txt_n'] + "。"
        speechText = speechText1 + "未来3天天气预报：" + speechText2 + speechText3 + speechText4
    except:
        speechText = "获取天气失败。"
    finally:
        vpaSay(speechText)
